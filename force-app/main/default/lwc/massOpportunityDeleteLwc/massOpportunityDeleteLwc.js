...
import deleteOpportunities from '@salesforce/apex/massOpportunityDeleteClass.deleteOpportunities';
import LightningAlert from 'lightning/alert';
export default class MassOpportunityDeleteLwc extends LightningElement {
    @api recordIds;
    arrayofString;
    selectedRecords;
    ...
    handleDeleteRecords(){
        if(this.arrayofString == ''){
            ...
            deleteOpportunities({oppIds:this.arrayofString})
            .then(result =>{
