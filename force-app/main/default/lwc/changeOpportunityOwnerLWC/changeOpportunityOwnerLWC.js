...
import getRecordsUsingRestApi from '@salesforce/apex/changeOpportunityOwnerController.getRecordsUsingRestApi';
import changeOwner from '@salesforce/apex/changeOpportunityOwnerController.changeOwner';

import { NavigationMixin } from 'lightning/navigation';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import LightningAlert from 'lightning/alert';

export default class ChangeOpportunityOwnerLWC extends NavigationMixin(LightningElement) {
    ...
    async connectedCallback() {
        ...
        this.label = `${this.selectedAccountSet.length} ${this.selectedAccountSet.length != 1 ? 'Opportunity\'s' : 'Opportunity'} Are Selected`
    ...
    handleSave() {
        ...
        changeOwner({ openOpp: this.openOpp, allOpp: this.allOpp, contacts: this.contacts, listOfAccountInJson: JSON.stringify(this.selectedAccountSet), newOwnerId: this.ownerId }).then(result => {
            ...
            setTimeout(() => {
                ...
                a.href = '/lightning/o/Opportunity/list?filterName=' + this.filterName;
                a.target = '_self';
                a.click();
            }, 2000);
